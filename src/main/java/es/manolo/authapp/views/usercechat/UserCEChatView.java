package es.manolo.authapp.views.usercechat;
...
@PageTitle("User-CE-Chat")
@Route(value = "chat", layout = MainLayout.class)
@RolesAllowed("USER")
public class UserCEChatView extends HorizontalLayout {
    ...
    public UserCEChatView() {
        addClassNames("user-ce-chat-view", Width.FULL, Display.FLEX, Flex.AUTO);
        setSpacing(false);
