package es.manolo.authapp.views.loggedcemd;
...
import es.manolo.authapp.data.SamplePerson;
import es.manolo.authapp.services.SamplePersonService;
...
@PageTitle("Logged-CE-MD")
@Route(value = "collaborative-master-detail/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@PermitAll
@Uses(Icon.class)
public class LoggedCEMDView extends Div implements BeforeEnterObserver {
    ...
    public LoggedCEMDView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("logged-cemd-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(LoggedCEMDView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(LoggedCEMDView.class);
            }
        }
    }
